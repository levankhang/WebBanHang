...
class Dangnhap extends CI_Controller {
    ...
    public function dangnhap(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            if($this->Mcustomer->customer_login($email, $password)!=FALSE){
                ...
                $this->session->set_userdata('sessionChayNgayDiStore',$row);
    ...
    public function dangxuat(){
        $array_items = array('user', 'fullname', 'id', 'access', 'cart','sessionChayNgayDiStore');
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'sale.levankhang197@gmail.com';
            ...
            $this->email->from('levankhang197@gmail.com', 'Admin');
            $list = array('levankhang197@gmail.com');
            $this->email->to($list);
            $this->email->subject('Hệ thống bán hàng');
