<html>
	...
	<body>
		<div style="font-family:&quot;Arial&quot;,Helvetica Neue,Helvetica,sans-serif;line-height:18pt">
			...
			?></p>
			<p>Cảm ơn Anh/chị đã đặt hàng tại <strong>Chạy Ngay Đi Store</strong>!</p>
	...
	&nbsp;
	<hr>
	<p style="text-align:right">Nếu Anh/chị có bất kỳ câu hỏi nào, xin liên hệ với chúng tôi tại <span style="color:#17a3dd"><a href="mailto:levankhang197@gmail.com" target="_blank">levankhang197@gmail.com</a></span></p>
	<p style="text-align:right"><i>Trân trọng,</i></p>
	<p style="text-align:right"><strong>Ban quản trị cửa hàng Chạy Ngay Đi Store</strong></p><div class="yj6qo"></div><div class="adL">
	</div>
	</div>
	</body>
</html>