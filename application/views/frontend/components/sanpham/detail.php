				...
				<?php if($row):?>
						...
						<div class="product-view-content">
							...
							<div class="actions-qty">
								...
								<div class="actions-qty__button">
									...
									<buttion class="hotline detail-hotline" aria-label="Hotline" title="Holine: 08.62632424" onclick="window.location.href='tel:01655544648'"><i class="fa fa-volume-control-phone" aria-hidden="true"></i>  01655544648</buttion>
								</div>
							</div>
					...
					<div class="product-comment product-v-desc">
						...
						<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
							<!-- <?php if(!$this->session->userdata('sessionChayNgayDiStore')):?>
